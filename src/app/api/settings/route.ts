...
export async function PUT(req: NextRequest) {
  try {
    ...
    const updateData: any = {
      ...
      ticketShowPhone: body.ticketShowPhone !== false,
      ticketShowSeller: body.ticketShowSeller !== false,
      ticketShowExchange: body.ticketShowExchange !== false,
      ticketCurrencyMode: body.ticketCurrencyMode || "dual",
      ticketShowSlogan: body.ticketShowSlogan === true,
      ticketBold: body.ticketBold !== false,
      ...
      ticketUseAgent: body.ticketUseAgent !== false,
